            ...
            <div className="card animate-fadeIn">
                ...
                <div className="grid md:grid-cols-[200px_1fr_200px] gap-6 items-start mb-8">
                    ...
                    <div className="hidden md:block">
                        <img
                            src={`${API_URL}${relatorio.chef_esquerda_url}`}
                            alt="Chef"
                    ...
                    <div className="hidden md:block">
                        <img
                            src={`${API_URL}${relatorio.chef_direita_url}`}
                            alt="Chef"
                            className="w-full rounded-xl shadow-lg"
                            onError={(e) => e.target.style.display = 'none'}
                        />
                    ...
                    <div className="bg-gradient-to-br from-purple-500/20 to-blue-600/20 border-2 border-purple-500/50 rounded-xl p-6">
                        ...
                        <div className="bg-black/30 rounded-lg overflow-hidden">
                            <table className="w-full">
                                ...
                                <tbody>
                                    {relatorio.pedido.itens.map((item, index) => (
                                        <tr key={index} className="border-b border-white/10">
                                            <td className="px-4 py-3 text-text-primary font-bold text-lg">{item.pizza_numero || (index + 1)}</td>
                                            ...
                                            <td className="px-4 py-3 text-center text-text-primary font-bold">{item.quantidade}</td>
                ...
                <div className="grid md:grid-cols-2 gap-6 items-start">
                    ...
                    <div className="bg-white/5 rounded-xl p-6 border border-white/10 text-center">
                        ...
                        <div className="bg-white p-4 rounded-lg inline-block mb-4">
                            <img
                                src={`${API_URL}${relatorio.qr_code_url}`}
                                alt="QR Code PIX"
