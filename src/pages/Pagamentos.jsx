...
import { formatLegacyEventDateBR } from '../utils/dates';
                        ...
                        >
                            ...
                            <div className="space-y-2 text-sm">
                                <div className="flex justify-between">
                                    ...
                                    <span className="text-text-primary font-medium">{formatLegacyEventDateBR(evento.data_evento)}</span>
                                </div>
                                <div className="flex justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-text-secondary">
                                    Evento em {formatLegacyEventDateBR(relatorio.evento.data_evento)}
                                </p>
                            </div>
                        </div>
