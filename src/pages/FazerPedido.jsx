...
import { Plus, Minus, ShoppingCart, AlertCircle, Edit, Star } from 'lucide-react';
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  {favoritos.map(fav => {
                    ...
                    return (
                      <div key={`fav-${sabor.id}`} className="card flex flex-col sm:flex-row items-start sm:items-center justify-between hover:shadow-xl transition-shadow border-l-4 border-yellow-400">
                        <div className="flex-1 mb-4 sm:mb-0">
                          ...
                          <p className="text-xs text-yellow-400/70 mt-1">Você já pediu {fav.total_pedacos} pedaços em {fav.total_eventos} pizzada{fav.total_eventos > 1 ? 's' : ''}</p>
                        </div>
                        <div className="flex items-center space-x-3">
                          ...
                          <button
                            ...
                            className="p-3 bg-yellow-500 hover:bg-yellow-600 text-white rounded-full transition-colors disabled:opacity-50"
