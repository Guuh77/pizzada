...
import { Pizza, LogOut, LayoutDashboard, User, Shield, Snowflake, DollarSign, Trophy } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          ...
          {user && (
            <nav className="flex items-center space-x-2 sm:space-x-6">
              ...
              <Link
                to="/ranking"
                className="flex items-center space-x-2 hover:text-yellow-400 transition-colors p-2 rounded-lg"
              >
                <Trophy size={20} />
